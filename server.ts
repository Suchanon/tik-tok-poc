...
app.get('/', (req: Request, res: Response) => {
    res.send(`
        ...
        <head>
            ...
            <title>TikTok Integration POC</title>
            <style>
                body {
        ...
        <body>
            <div class="container">
                <div class="logo">
                    <svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 1 0-1 13.6 6.84 6.84 0 0 0 6.82-6.85V7.97a7.3 7.3 0 0 0 4.39 1.47v-3.44a3.9 3.9 0 0 1-1-.21z"/></svg>
                </div>
                <h1>TikTok Integration</h1>
                <p>Connect your TikTok account to access profile data, stats, and manage webhooks.</p>
                <a href="/auth/tiktok" class="btn">
                    <svg class="tiktok-icon" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 1 0-1 13.6 6.84 6.84 0 0 0 6.82-6.85V7.97a7.3 7.3 0 0 0 4.39 1.47v-3.44a3.9 3.9 0 0 1-1-.21z"/></svg>
                    Connect TikTok
                </a>
                <div style="margin-top: 16px;">
                    <a href="https://www.tiktok.com" target="_blank" style="color: #86909c; text-decoration: none; font-size: 14px; border-bottom: 1px dashed #86909c;">
                        Stuck? Open TikTok to Logout
                    </a>
                </div>
            </div>
        </body>
